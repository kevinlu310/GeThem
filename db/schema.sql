...
INSERT INTO `need` (`need_id`, `need_author_id`, `need_title`, `need_content`, `need_pub_date`, `tag`) VALUES
...
(17, 1, 'test tag empty', 'yes.', 1356551080, 'others'),
(18, 1, 'empty tag again', 'test.', 1356551835, 'others');
...
INSERT INTO `provide` (`provide_id`, `provide_author_id`, `provide_title`, `provide_content`, `provide_pub_date`, `tag`) VALUES
(1, 1, 'Bike', 'good one', 1351362571, 'others'),
(2, 1, 'fsfadsfd', 'good one', 1351362636, 'others'),
(3, 2, 'Car', 'good', 1351365245, 'others'),
(4, 1, 'A lot of things', 'fjsldkjflkdsjlf', 1351365443, 'others'),
(5, 1, 'new offer', 'test', 1351365562, 'others'),
(6, 1, 'fsdfsd', '534534523', 1351365721, 'others'),
(7, 1, 'yyy', 'ttt', 1351365973, 'others'),
(8, 1, 'uuu', 'uuuuu', 1351366029, 'others'),
(9, 1, 'tt', 'xx', 1351366078, 'others'),
(10, 1, 'useful', 'work', 1351366158, 'others'),
(11, 1, 'cup', 'a good cup', 1351366378, 'others'),
(12, 1, 'rrr', 'qqqq', 1351366444, 'others'),
(13, 1, 'urutyu', 'poiopui', 1351366685, 'others'),
(14, 2, 'I have another book', 'story', 1351366811, 'others'),
(15, 1, '777gdfgdf', 'gdfgsdfgdfsg', 1351366918, 'others'),
(16, 1, 't', 'ds', 1351367034, 'others'),
(17, 1, 'use', 'fjsdjflk', 1351367094, 'others'),
...
(19, 1, 'tag empty', 'what happened?', 1356551094, 'others'),
(20, 1, 'empty tag again', 'good', 1356551909, 'others');
